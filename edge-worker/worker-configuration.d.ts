/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cafac61748c1db344bb57fd0bcdc0fec)
// Runtime types generated with workerd@1.20260415.1 2026-04-16 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AbuseGuard" | "GitHubApiGuard";
	}
	interface Env {
		GAME_ROWS: "9";
		GAME_COLS: "9";
		GAME_MINES: "10";
		ABUSE_GUARD: DurableObjectNamespace<import("./src/index").AbuseGuard>;
		GITHUB_API_GUARD: DurableObjectNamespace<import("./src/index").GitHubApiGuard>;
	}
}
